...
const InternationalOnlineComp: React.FC = () => {
  ...
  useEffect(() => {
    const scriptURL =
      "https://script.google.com/macros/s/AKfycbzCp5-yC7nW81L401LCwYZq94EjvNJDwnMHi3k4UC8VhcGY849FUqeYui2lpV40nzQQ/exec";
...
const HeaderSection: React.FC = () => (
  <div className="header-section">
    <div className="header-content">
      ...
      <h2 className="event-title">IYCO 2026</h2>
    </div>
  </div>
);
...
const InstructionSection: React.FC = () => (
  <div className="instruction-section">
    <h3 className="instruction-title">
      HELLO IYCO 2026 PARTICIPANTS, Please consider the following information before filling out the registration form :
    </h3>
...
const InformasiUmumSection: React.FC = () => (
  <section className="form-section">
    ...
    <div className="field-grid">
      ...
      <div className="field-group">
        <label className="field-label">IYCO 2026 Competition Information Resources</label>
        <select name="INFORMATION_RESOURCES" className="select-field" required>
          ...
          <option value="IYCO Instagram">IYCO Instagram</option>
          <option value="Supervisor/School">Supervisor/School</option>
          <option value="IYSA FaceBook">IYSA FaceBook</option>
          <option value="IYSA Linkedin">IYSA Linkedin</option>
          <option value="IYSA Website">IYSA Website</option>
          <option value="IYCO Website">IYCO Website</option>
          <option value="IYSA Email">IYSA Email</option>
          <option value="IYCO Email">IYCO Email</option>
