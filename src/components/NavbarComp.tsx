    ...
    return(
        ...
        <header>
            <Link href="/">
                <Image 
                    className='logo-nav' 
                    src="/assets/images/logo/IYCO.png" 
                    alt="IYCO Logo" 
                    width={100} 
                    height={50}
                    priority
            ...
            <div className='navigation'>
                <ul className='menu'>
                    ...
                    <li className='menu-item'>
                        <Link href="https://drive.google.com/file/d/1-eIYaEq6btaO41-XnlutwoGWxhnsgHeH/view?usp=sharing" 
                            target='_blank'
                    ...
                    <li className='menu-item'>
                        ...
                        <ul className='sub-menu'>
                            <li className='sub-item'>
                                <Link href="https://drive.google.com/drive/folders/1HQh-tFs4e_pvtTbkhkfItuek9K1uiPva?usp=sharing" 
                                    target='_blank' 
                                    rel="noopener noreferrer">
                            ...
                            <li className='sub-item'>
                                <Link href="https://drive.google.com/drive/folders/1LF5whS8Cpf87KcP1-A0VYDn-qNkEF1JO?usp=sharing" 
                                    target='_blank' 
                                    rel="noopener noreferrer">
                            ...
                            <li className='sub-item'>
                                <Link href="https://drive.google.com/drive/folders/19hFi_DN6XoGkbQVctLeuvc6mvrAxaBJB?usp=sharing" 
                                    target='_blank' 
                                    rel="noopener noreferrer">
                    ...
                    <li className='menu-item'>
                        ...
                        <ul className='sub-menu'>
                            ...
                            <li className='sub-item'>
                                <Link href="https://drive.google.com/drive/folders/1hGdRrLTdK1QvfM_S5b9abJ64Ok8JahVE?usp=sharing" 
                                    target='_blank' 
                                    rel="noopener noreferrer">
                                        2024
                                </Link>
