    ...
    return(
        ...
        <section className="post news-container news-section">
            <div className="post-box">
                ...
                <Image src="/assets/images/news/news1.jpg" alt="" className="post-img" width={800} height={600}/>
                ...
                <div className="profile">
                    <Image src="/assets/images/news/Logo Profile News1.png" alt="" className="profile-img" width={40} height={40}/>
